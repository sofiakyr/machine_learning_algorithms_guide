...
When we apply such a function we have manged to overcome some of the pitfalls of polynomial regression but the model whould be discontinious at the point of the knot. It whould look similar to the privious example of step functions where at points the function was missing out 'smoothness'.

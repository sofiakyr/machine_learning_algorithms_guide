...
There are also a few multi-variant approaches in defining outliers. For example the Cooks Distance which measures the
...
affect the fit of the regression line.

...
$P(x) = e^{(b0 + b1X)} \div (1 + e^{(b0 + b1X)})$, where $b0$ and $b1$ are our coefficients, this makes an S-shaped
curve where the edges are $0$ and $1$. We want to try and bring this in a more linear form, after manipulation we can
see that:
